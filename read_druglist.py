...
# ตรวจว่ามีการค้นหาหรือกรองหรือไม่
has_filter = (
    bool(search)
    or bool(sub1)
    or bool(sub2)
...
if has_filter:
    ...
    # ---------------------------------------------
    # นับจำนวน Drug Card จริง
    # แยกตาม:
    # drug_name + account_sub + account_drug_ID
    # ---------------------------------------------
    ...
    st.write(
        f"พบ **{card_count:,} Drug Cards**"
    )

else:

    # ---------------------------------------------
    # ยังไม่ได้ค้นหาหรือกรอง
    # ใช้จำนวนรายการจาก Excel เหมือนเดิม
    # ---------------------------------------------

    st.write(
        f"รายการยา **{len(df_filter):,} รายการ**"
    )
